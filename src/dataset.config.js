...
export default {
  ...
  datasetPackage: '@metanull/the-use-of-colours-in-art-data',
  ...
  siteName: manifest.site?.names?.en ?? 'The Use of Colours in Art',
  ...
  site: { origin: 'https://metanull.github.io/the-use-of-colours-in-art' },
